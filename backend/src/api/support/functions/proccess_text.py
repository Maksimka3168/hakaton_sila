...
def preprocess_text(text):
    ...
    typo_dict = {
        ...
        'сдх': 'СДХ', 'ЗУ': 'Аккумулятор', 'ОС': 'Программное обеспечение', 'bios': 'Программное обеспечение', 'BIOS': 'Программное обеспечение',
        'SSD': 'Диск', 'Disk': 'Диск', 'антенна': 'модуль', 'антенны': 'модуль'
    }
